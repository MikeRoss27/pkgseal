...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      ...
      className={cn(
        "cn:group/tabs cn:flex cn:gap-2 cn:data-[orientation=horizontal]:flex-col",
        className
      )}
      {...props}
    />
...
const tabsListVariants = cva(
  "cn:group/tabs-list cn:inline-flex cn:w-fit cn:items-center cn:justify-center cn:rounded-lg cn:p-[3px] cn:text-muted-foreground cn:group-data-[orientation=horizontal]/tabs:h-8 cn:group-data-[orientation=vertical]/tabs:h-fit cn:group-data-[orientation=vertical]/tabs:flex-col cn:data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "cn:bg-muted",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "cn:after:absolute cn:after:bg-foreground cn:after:opacity-0 cn:after:transition-opacity cn:group-data-[orientation=horizontal]/tabs:after:inset-x-0 cn:group-data-[orientation=horizontal]/tabs:after:bottom-[-5px] cn:group-data-[orientation=horizontal]/tabs:after:h-0.5 cn:group-data-[orientation=vertical]/tabs:after:inset-y-0 cn:group-data-[orientation=vertical]/tabs:after:-right-1 cn:group-data-[orientation=vertical]/tabs:after:w-0.5 cn:group-data-[variant=line]/tabs-list:data-active:after:opacity-100",
        className
      )}
      {...props}
    />
